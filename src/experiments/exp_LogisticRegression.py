...
visualize_classification_report(clf_report,model_name='LogisticRegression')
...
test_labels.to_csv(results_dir+"Submission_LogisticRegression.csv",index=None)



my_plot_roc_curve(clf,X_test,y_test,model_name='LogisticRegression', fig_name='LogisticRegression_test')
visualize_confusion_matrix(clf,X_test,y_test,title='LogisticRegression',fig_name='LogisticRegression_test',normalize='true')
#visualize_roc_curve([clf],X_test,y_test,title='LogisticRegression',fig_name='LogisticRegression_test')