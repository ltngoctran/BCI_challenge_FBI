...
clf_svm = SVC(C=100,gamma=0.001,probability=True)
...
visualize_classification_report(clf_report,model_name='SVM')
...
test_labels.to_csv(results_dir+"Submission_SVM.csv",index=None)



my_plot_roc_curve(clf_svm,X_test,y_test,model_name='SVM', fig_name='SVM_test')
visualize_confusion_matrix(clf_svm,X_test,y_test,title='SVM',fig_name='SVM_test',normalize='true')
#visualize_roc_curve([clf_svm],X_test,y_test,title='SVM',fig_name='SVM_test')