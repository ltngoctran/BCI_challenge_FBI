...
from ..lib.tools.visualization import my_plot_roc_curve, visualize_confusion_matrix, visualize_roc_curve
...
clf_svm = SVC(C=0.01,gamma=0.001,probability=True)
...
list_clf = [clf_svm, clf_rf, clf_lg]

visualize_roc_curve(list_clf,X_test,y_test,title='ROC',fig_name='compare_test')